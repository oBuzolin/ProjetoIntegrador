...
class Nota_Teste(models.Model):
    aluno = models.ForeignKey(Minerva_Aluno, on_delete=models.CASCADE)
    turma = models.ForeignKey(Turma_Teste, on_delete=models.CASCADE)
    valor = models.DecimalField(max_digits=5, decimal_places=2)  # Exemplo para a not
