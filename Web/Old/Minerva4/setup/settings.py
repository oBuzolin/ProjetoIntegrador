...
SECRET_KEY = 'django-insecure-_9_+jqr_khr$v#iy=4q0my+n&xf!56k9$*(77q40r$%_h(nif3'
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware',  # Importante para sessão
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Importante para autenticação
