...
from .models import Minerva_Professor, ProfessorTurma_Teste, Turma_Teste, Disciplina_Teste, MuralMensagem_Teste, Matricula_Turma
...
def alunos_detalhes(request, matricula, id_Turma):
    ...
    alunos_matriculados = Matricula_Turma.objects.filter(id_Turma=id_Turma).select_related('ra')
    turmas_detalhes = [{
        'id_Turma': turma.id_Turma.id_Turma,
        'nome_turma': turma.id_Turma.nomeTurma,
        'disciplina': Disciplina_Teste.objects.get(id_Turma=turma.id_Turma).nome_disciplina,
