...
class Application(BackEnd):
        ...
        def telaLogin(self):
            ...
            self.senha_entry = ctk.CTkEntry(master=login_frame, placeholder_text="Email", width=300,
            ...
            self.checkbox = ctk.CTkCheckBox(master=login_frame, text="Lembre-se de mim sempre").place(x=25, y=305)

            self.login_buttom = ctk.CTkButton(master=login_frame, text="LOGIN", width=300, command=self.verifica_login).place(x=25, y=355)
